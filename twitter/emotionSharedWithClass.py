...
def getListOfLines():
    ...
    infileObject=codecs.open("C:\Users\mpagnis\Documents\personal\SMM\Social_Media_Mining\neg.txt", "r", "utf-8") # you can also have the script receive the input file on the command line via using "sys.argv[1]" more on this next time...
